...
(assert (forall ((x_43 MutInt_0) (x_41 Nat_0) (x_42 Nat_0))
	(=> (= x_43 (mutInt_1 x_41 x_42))
	    (curInt_1 x_41 x_43))))
(assert (forall ((x_43 MutInt_0) (x_41 Nat_0) (x_42 Nat_0))
	(=> (= x_43 (mutInt_1 x_41 x_42))
	    (retInt_1 x_42 x_43))))
(assert (forall ((x_44 Nat_0) (x_45 Nat_0))
	(ismutInt_0 (mutInt_1 x_44 x_45))))
(assert (forall ((x_46 Nat_0) (x_47 Nat_0) (x_48 Nat_0) (x_49 Nat_0))
	(=> (diseqNat_0 x_46 x_48)
	    (diseqMutInt_0 (mutInt_1 x_46 x_47) (mutInt_1 x_48 x_49)))))
(assert (forall ((x_46 Nat_0) (x_47 Nat_0) (x_48 Nat_0) (x_49 Nat_0))
...
(assert (forall ((x_0 Bool) (x_1 MutInt_0) (x_2 Nat_0) (x_3 Nat_0) (x_4 Nat_0) (x_5 Nat_0) (x_6 Nat_0) (x_7 Nat_0) (x_29 Nat_0) (x_30 Nat_0) (x_50 Nat_0) (x_51 Nat_0))
	(=>	(and (takemax_0 (mutInt_1 x_2 x_5) (mutInt_1 x_3 x_7) x_1)
			...
			(main_1 true x_0)
			(= x_4 x_30)
			(add_0 x_29 x_51 (S_0 Z_0))
			(add_0 x_30 x_6 (S_0 Z_0))
			(retInt_1 x_50 x_1)
			(curInt_1 x_51 x_1))
		(main_0 x_0))))
(assert (forall ((x_0 Bool) (x_1 MutInt_0) (x_2 Nat_0) (x_3 Nat_0) (x_4 Nat_0) (x_5 Nat_0) (x_6 Nat_0) (x_7 Nat_0) (x_31 Nat_0) (x_32 Nat_0) (x_52 Nat_0) (x_53 Nat_0))
	(=>	(and (takemax_0 (mutInt_1 x_2 x_5) (mutInt_1 x_3 x_7) x_1)
			(= x_6 x_7)
			(= x_4 x_5)
			(= x_52 x_31)
			(main_1 false x_0)
			(diseqNat_0 x_4 x_32)
			(add_0 x_31 x_53 (S_0 Z_0))
			(add_0 x_32 x_6 (S_0 Z_0))
			(retInt_1 x_52 x_1)
			(curInt_1 x_53 x_1))
		(main_0 x_0))))
...
(assert (forall ((x_10 MutInt_0) (x_11 MutInt_0) (x_12 MutInt_0) (x_56 Nat_0) (x_57 Nat_0))
	(=>	(and (takemax_1 x_10 x_11 false x_12)
			(lt_0 x_56 x_57)
			(curInt_1 x_56 x_10)
			(curInt_1 x_57 x_11))
		(takemax_0 x_10 x_11 x_12))))
(assert (forall ((x_13 MutInt_0) (x_14 MutInt_0) (x_15 MutInt_0) (x_16 Nat_0) (x_17 Nat_0) (x_18 Nat_0) (x_19 Nat_0) (x_58 Nat_0) (x_59 Nat_0) (x_60 Nat_0) (x_61 Nat_0))
	(=>	(and (= x_16 x_17)
			(= x_17 x_18)
			(= x_18 x_19)
			(= x_58 x_16)
			(= x_59 x_60)
			(= x_15 (mutInt_1 x_61 x_19))
			(retInt_1 x_58 x_14)
			(retInt_1 x_59 x_13)
			(curInt_1 x_60 x_13)
			(curInt_1 x_61 x_14))
		(takemax_1 x_13 x_14 false x_15))))
(assert (forall ((x_20 MutInt_0) (x_21 MutInt_0) (x_22 MutInt_0) (x_23 Nat_0) (x_24 Nat_0) (x_25 Nat_0) (x_26 Nat_0) (x_62 Nat_0) (x_63 Nat_0) (x_64 Nat_0) (x_65 Nat_0))
	(=>	(and (= x_23 x_24)
			(= x_24 x_25)
			(= x_25 x_26)
			(= x_62 x_63)
			(= x_64 x_23)
			(= x_22 (mutInt_1 x_65 x_26))
			(retInt_1 x_62 x_21)
			(curInt_1 x_63 x_21)
			(retInt_1 x_64 x_20)
			(curInt_1 x_65 x_20))
