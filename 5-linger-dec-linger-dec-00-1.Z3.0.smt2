...
(assert (forall ((x_40 MutInt_0) (x_38 Nat_0) (x_39 Nat_0))
	(=> (= x_40 (mutInt_1 x_38 x_39))
	    (curInt_1 x_38 x_40))))
(assert (forall ((x_40 MutInt_0) (x_38 Nat_0) (x_39 Nat_0))
	(=> (= x_40 (mutInt_1 x_38 x_39))
	    (retInt_1 x_39 x_40))))
(assert (forall ((x_41 Nat_0) (x_42 Nat_0))
	(ismutInt_0 (mutInt_1 x_41 x_42))))
(assert (forall ((x_43 Nat_0) (x_44 Nat_0) (x_45 Nat_0) (x_46 Nat_0))
	(=> (diseqNat_0 x_43 x_45)
	    (diseqMutInt_0 (mutInt_1 x_43 x_44) (mutInt_1 x_45 x_46)))))
(assert (forall ((x_43 Nat_0) (x_44 Nat_0) (x_45 Nat_0) (x_46 Nat_0))
...
(assert (forall ((x_0 MutInt_0) (x_1 Bool) (x_27 Nat_0) (x_47 Nat_0) (x_48 Nat_0))
	(=>	(and (lingerdec_1 (mutInt_1 x_27 x_47) x_1)
			(minus_0 x_27 x_48 (S_0 Z_0))
			(retInt_1 x_47 x_0)
			(curInt_1 x_48 x_0))
		(lingerdec_0 x_0))))
...
(assert (forall ((x_5 MutInt_0) (x_49 Nat_0) (x_50 Nat_0))
	(=>	(and (= x_49 x_50)
			(retInt_1 x_49 x_5)
			(curInt_1 x_50 x_5))
		(lingerdec_1 x_5 true))))
(assert (forall ((x_6 MutInt_0) (x_7 Nat_0) (x_8 Nat_0) (x_9 Nat_0) (x_10 Nat_0) (x_51 Nat_0) (x_52 Nat_0))
	(=>	(and (= x_8 x_9)
			(lingerdec_0 (mutInt_1 x_51 x_10))
			(= x_9 x_10)
			(= x_52 x_8)
			(curInt_1 x_51 x_6)
			(retInt_1 x_52 x_6))
		(lingerdec_2 x_6 x_7 false))))
(assert (forall ((x_11 MutInt_0) (x_12 Nat_0) (x_13 Nat_0) (x_14 Nat_0) (x_15 Nat_0) (x_16 Nat_0) (x_53 Nat_0) (x_54 Nat_0))
	(=>	(and (= x_13 x_14)
			(= x_14 x_15)
...
(assert (forall ((x_17 Bool) (x_18 Nat_0) (x_19 Nat_0) (x_20 Nat_0) (x_24 Bool) (x_28 Nat_0))
	(=>	(and (lingerdec_0 (mutInt_1 x_18 x_20))
			(= x_19 x_20)
			(main_1 x_24 x_17)
			(gt_0 x_28 x_19)
			(not_0 x_24 true)
			(minus_0 x_28 x_18 (S_0 Z_0)))
		(main_0 x_17))))
(assert (forall ((x_17 Bool) (x_18 Nat_0) (x_19 Nat_0) (x_20 Nat_0) (x_25 Bool) (x_29 Nat_0))
	(=>	(and (lingerdec_0 (mutInt_1 x_18 x_20))
			(= x_19 x_20)
			(main_1 x_25 x_17)
			(le_0 x_29 x_19)
			(not_0 x_25 false)
			(minus_0 x_29 x_18 (S_0 Z_0)))
		(main_0 x_17))))
