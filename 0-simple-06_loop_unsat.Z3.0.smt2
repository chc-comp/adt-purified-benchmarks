...
(assert (forall ((y_0 Nat_0))
	(add_0 y_0 Z_0 y_0)))
(assert (forall ((x_14 Nat_0) (y_0 Nat_0) (r_0 Nat_0))
	(=> (add_0 r_0 x_14 y_0)
	    (add_0 (S_0 r_0) (S_0 x_14) y_0))))
(assert (forall ((y_0 Nat_0))
	(minus_0 Z_0 Z_0 y_0)))
(assert (forall ((x_14 Nat_0) (y_0 Nat_0) (r_0 Nat_0))
	(=> (minus_0 r_0 x_14 y_0)
	    (minus_0 (S_0 r_0) (S_0 x_14) y_0))))
(assert (forall ((y_0 Nat_0))
	(le_0 Z_0 y_0)))
(assert (forall ((x_14 Nat_0) (y_0 Nat_0))
	(=> (le_0 x_14 y_0)
	    (le_0 (S_0 x_14) (S_0 y_0)))))
(assert (forall ((y_0 Nat_0))
	(ge_0 y_0 Z_0)))
(assert (forall ((x_14 Nat_0) (y_0 Nat_0))
	(=> (ge_0 x_14 y_0)
	    (ge_0 (S_0 x_14) (S_0 y_0)))))
(assert (forall ((y_0 Nat_0))
	(lt_0 Z_0 (S_0 y_0))))
(assert (forall ((x_14 Nat_0) (y_0 Nat_0))
	(=> (lt_0 x_14 y_0)
	    (lt_0 (S_0 x_14) (S_0 y_0)))))
(assert (forall ((y_0 Nat_0))
	(gt_0 (S_0 y_0) Z_0)))
(assert (forall ((x_14 Nat_0) (y_0 Nat_0))
	(=> (gt_0 x_14 y_0)
	    (gt_0 (S_0 x_14) (S_0 y_0)))))
(assert (forall ((y_0 Nat_0))
	(mult_0 Z_0 Z_0 y_0)))
(assert (forall ((x_14 Nat_0) (y_0 Nat_0) (r_0 Nat_0) (z_1 Nat_0))
	(=>	(and (mult_0 r_0 x_14 y_0)
			(add_0 z_1 r_0 y_0))
		(mult_0 z_1 (S_0 x_14) y_0))))
(assert (forall ((x_14 Nat_0) (y_0 Nat_0))
	(=> (lt_0 x_14 y_0)
	    (div_0 Z_0 x_14 y_0))))
(assert (forall ((x_14 Nat_0) (y_0 Nat_0) (r_0 Nat_0) (z_1 Nat_0))
	(=>	(and (ge_0 x_14 y_0)
			(minus_0 z_1 x_14 y_0)
			(div_0 r_0 z_1 y_0))
		(div_0 (S_0 r_0) x_14 y_0))))
(assert (forall ((x_14 Nat_0) (y_0 Nat_0))
	(=> (lt_0 x_14 y_0)
	    (mod_0 x_14 x_14 y_0))))
(assert (forall ((x_14 Nat_0) (y_0 Nat_0) (r_0 Nat_0) (z_1 Nat_0))
...
(assert (forall ((x_0 Bool) (x_1 Bool))
	(=> (main_1 (S_0 Z_0) Z_0 x_1 x_0)
	    (main_0 x_0))))
(assert (forall ((x_2 Nat_0) (x_3 Nat_0) (x_4 Bool) (x_12 Bool))
	(=>	(and (main_2 x_12 x_4)
			(ge_0 x_2 x_3)
			(not_0 x_12 true))
		(main_1 x_2 x_3 false x_4))))
(assert (forall ((x_2 Nat_0) (x_3 Nat_0) (x_4 Bool) (x_13 Bool))
	(=>	(and (main_2 x_13 x_4)
			(lt_0 x_2 x_3)
			(not_0 x_13 false))
		(main_1 x_2 x_3 false x_4))))
(assert (forall ((x_5 Nat_0) (x_6 Nat_0) (x_7 Bool) (x_8 Bool) (x_15 Nat_0) (x_16 Nat_0))
	(=>	(and (main_1 x_15 x_16 x_8 x_7)
			(add_0 x_15 x_5 x_6)
			(add_0 x_16 x_6 (S_0 Z_0)))
