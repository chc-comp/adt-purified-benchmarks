...
(assert (forall ((n_0 Nat_0) (xs_1 Lst_0) (rs_0 Lst_0) (ys_1 Lst_0))
	(=>	(and (= ys_1 (cons_0 n_0 xs_1))
			(= xs_1 nil_0))
		(butlast_0 ys_1 nil_0))))
(assert (forall ((n_1 Nat_0) (xs_2 Lst_0) (rs_1 Lst_0) (ys_2 Lst_0) (x_1 Nat_0) (zs_0 Lst_0))
	(=>	(and (butlast_0 xs_2 rs_1)
			(= ys_2 (cons_0 n_1 xs_2))
			(= xs_2 (cons_0 x_1 zs_0)))
		(butlast_0 ys_2 (cons_0 n_1 rs_1)))))
(assert (forall ((xs_3 Lst_0) (ys_3 Lst_0) (zs_1 Lst_0) (n_2 Nat_0) (l_1 Nat_0) (l_2 Nat_0) (x_4 Nat_0))
	(=>	(and (= ys_3 (cons_0 n_2 xs_3))
			(butlast_0 ys_3 zs_1)
			(length_0 ys_3 l_1)
			(length_0 zs_1 l_2)
			(diseqNat_0 x_4 l_1)
			(add_0 x_4 l_2 (S_0 Z_0)))
		false)))
(check-sat)
